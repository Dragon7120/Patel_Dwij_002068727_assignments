...
public class Info5001UniversityExample {
    ...
    public static void main(String[] args) {
        ...
        for (int i=0;i<sd.studentlist.size();i++){
            System.out.println("Student is "+sd.studentlist.get(i).person.getPersonId()+" and his course registration is: ");
            ...
            for (int j=0;j<sd.studentlist.get(i).getCurrentCourseLoad().getSeatAssignments().size();j++){ 
                ...
                System.out.println("Course: "+co.getCourseNumber());
                System.out.println("Teachers are: ");
                for (int k=0;k<fac_cou_map.get(co).size();k++){
                    System.out.println(fac_cou_map.get(co).get(k).getFacultyProfile().person.getPersonId());
                }
                ...
                System.out.println("Credits are "+sd.studentlist.get(i).getCurrentCourseLoad().getSeatAssignments().get(j).getSeat().getCourseOffer().getCreditHours());
            ...
            System.out.println("GPA is "+totalCredits/totalcreditPoints);
            System.out.println("Total tuition fees is "+fees);
            System.out.println("\n");
        }
